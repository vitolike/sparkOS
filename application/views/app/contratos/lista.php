    ...
    <div role="main" class="container-fluid px-md-5">
        ...
        <?php if ($msg == 'sucesso_contrato'): ?>
            <div class="alert alert-modern alert-success-modern alert-dismissible fade show mb-4" role="alert">
                <strong><i class="fas fa-check-circle"></i>&nbsp; Sucesso!</strong> Novo contrato ou proposta comercial cadastrado com sucesso.
        ...
        <?php elseif ($msg == 'sucesso_status'): ?>
            <div class="alert alert-modern alert-success-modern alert-dismissible fade show mb-4" role="alert">
                <strong><i class="fas fa-check-circle"></i>&nbsp; Sucesso!</strong> Status do contrato comercial atualizado.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="color: inherit; opacity: 0.7;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
        <?php elseif ($msg == 'sucesso_assinatura'): ?>
            <div class="alert alert-modern alert-success-modern alert-dismissible fade show mb-4" role="alert">
                <strong><i class="fas fa-check-circle"></i>&nbsp; Sucesso!</strong> Contrato assinado eletronicamente via token certificado digital.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="color: inherit; opacity: 0.7;">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
