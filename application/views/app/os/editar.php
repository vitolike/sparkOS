    ...
    <div role="main" class="container">
        ...
        <div class="my-3 p-4 rounded box-shadow">
            <h5 class="card-title">
                <i class="fas fa-edit mr-2 text-pink" style="color: #ec4899;"></i>
                <b>Edição de Ordem de Serviço</b>
            </h5>
            <p class="text-muted mb-4" style="font-size: 13px;">Atualize as informações, status e laudos técnicos da Ordem de Serviço #<?= $query[0]->idos; ?>.</p>
            
            <form method="post" role="form" action="<?= base_url(); ?>os/atualizar">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <input type="hidden" id="cliente" name="cliente" value="<?= $query[0]->cliente; ?>">
                            <input type="text" class="form-control" id="nome_cliente" name="nome_cliente" value="<?= $query[0]->nome_cliente; ?>" readonly placeholder="Clique em Procurar..." required style="background-color: #f8fafc !important; cursor: pointer;" data-toggle="modal" data-target="#procurarClientes">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group">
                            <input type="hidden" id="tecnico" name="tecnico" value="<?= $query[0]->tecnico; ?>" required>
                            <input type="text" class="form-control" id="nome_tecnico" name="nome_tecnico" value="<?= $query[0]->nome_tecnico; ?>" readonly placeholder="Clique em Procurar..." required style="background-color: #f8fafc !important; cursor: pointer;" data-toggle="modal" data-target="#procurarTecnico">
                            <div class="input-group-append">
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" data-provide="datepicker" value="<?= $query[0]->data_final; ?>" data-date-format="DD-MM-YYYY" id="data_final" name="data_final" required>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="garantia" name="garantia" max="999" placeholder="0" maxlength="3" value="<?= $query[0]->garantia; ?>">
                            <div class="input-group-append">
                ...
                <div class="form-row mt-3">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" name="descricao" rows="4" placeholder="Descreva o equipamento ou escopo do serviço..." required><?= $query[0]->descricao; ?></textarea>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="defeito">Defeito Reclamado / Constatado</label>
                        <textarea class="form-control" name="defeito" rows="4" placeholder="Sintomas informados pelo cliente..." required><?= $query[0]->defeito; ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-row mt-3">
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" name="observacoes" rows="4" placeholder="Observações internas importantes..." required><?= $query[0]->observacoes; ?></textarea>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="laudo_tecnico">Laudo Técnico Preliminar</label>
                        <textarea class="form-control" name="laudo_tecnico" rows="4" placeholder="Diagnóstico do especialista ou laudo preliminar..." required><?= $query[0]->laudo_tecnico; ?></textarea>
                    </div>
                </div>
