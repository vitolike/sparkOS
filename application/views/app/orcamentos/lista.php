...
<?php if ($o->status == 'RASCUNHO'): ?><a href="<?= base_url(); ?>orcamentos/update_status/<?= $o->idorcamento; ?>/ENVIADO" class="btn btn-sm btn-info py-1 px-2" title="Enviar"><i class="fas fa-paper-plane"></i></a><?php endif; ?>
<?php if ($o->status == 'ENVIADO'): ?><a href="<?= base_url(); ?>orcamentos/update_status/<?= $o->idorcamento; ?>/APROVADO" class="btn btn-sm btn-success py-1 px-2" title="Aprovar"><i class="fas fa-check"></i></a><?php endif; ?>
<button class="btn btn-sm btn-primary py-1 px-2 btn-edit" data-id="<?= $o->idorcamento; ?>"><i class="fas fa-edit"></i></button>
<a href="<?= base_url(); ?>orcamentos/delete/<?= $o->idorcamento; ?>" class="btn btn-sm btn-danger py-1 px-2" onclick="return confirm('Excluir?');"><i class="fas fa-trash"></i></a>
